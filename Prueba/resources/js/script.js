    ...
    onGetTask((querySnapshot) => {
        ...
        querySnapshot.forEach(doc => {
            ...
            taskContainer.innerHTML += `
                ...
                <td><button class='btn btn-secondary btn-edit' data-id="${doc.id}">${iconoEditar}</button></td>
                <td><button class='btn btn-primary btn-delete' data-id="${doc.id}">${iconoBorrar}</button></td>
                <p>        
            `
        })
